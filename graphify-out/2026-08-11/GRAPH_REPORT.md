...
## Corpus Check
- 204 files · ~129,196 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2359 nodes · 3322 edges · 161 communities (144 shown, 17 thin omitted)
...
Cohesion: 0.14
Nodes (15): admin_user_detail_page.dart, _buildListItem, _buildFeedItem, _activeTab, _buildEmployeeCard, _buildEmployeeTab, _buildOutletCard, _buildOutletTab (+7 more)
...
Cohesion: 0.13
Nodes (16): ../data/admin_repository.dart, AdminRepository, _AdminUsersPageState, build, accounts, activeBrand, allUsers, employeeAccountsProvider (+8 more)
...
Cohesion: 0.10
Nodes (20): build, ChangePasswordPage, _confirmationController, controller, createState, _currentPasswordController, dispose, _errorMessage (+12 more)

### Community 22 - "auth_interceptor.dart"
Cohesion: 0.11
Nodes (18): auth_api_client.dart, auth_interceptor.dart, Interceptor, authInterceptor, _create, delete, _dio, forTesting (+10 more)

### Community 23 - "home_page.dart"
Cohesion: 0.10
Nodes (21): CustomPainter, dart:math, ../../holiday/providers/holiday_providers.dart, build, _buildOptions, _buildOptionTile, _buildStatusCard, _buildStatusRow (+13 more)

### Community 24 - "login_page.dart"
Cohesion: 0.13
Nodes (15): createState, dispose, _emailController, _emailFocusNode, errorMessage, initState, _isAdminMode, _isLoading (+7 more)
...
Cohesion: 0.08
Nodes (29): admin_attendance_detail_page.dart, Color, ../../core/constants/app_colors.dart, ../../core/providers/brand_provider.dart, ../../../core/utils/date_utils.dart, record, _buildCompactStat, _buildMenuItem (+21 more)
...
Cohesion: 0.15
Nodes (15): changePasswordRequest, loginRequest, principal, refreshRequest, sessionResponse, userResponse, Server, Context (+7 more)

### Community 32 - "ConsumerState"
Cohesion: 0.33
Nodes (6): initState, SplashScreen, _SplashScreenState, userRoleProvider, Route /change-password, TickerProviderStateMixin
...
Cohesion: 0.13
Nodes (28): ConsumerState, ConsumerWidget, activeBrandProvider, AdminAttendanceDetailPage, build, AdminDashboardPage, build, todayAttendanceCountProvider (+20 more)

### Community 38 - "admin_dashboard_page.dart"
Cohesion: 0.22
Nodes (13): CameraSection, _CameraSectionState, _LoadingPulse, _LoadingPulseState, AdminShell, _AdminShellState, MainShell, _MainShellState (+5 more)
...
Cohesion: 0.12
Nodes (15): ../../features/attendance/presentation/history_page.dart, ../../features/attendance/presentation/home_page.dart, ../../features/profile/presentation/profile_page.dart, _BottomNav, build, _buildNavItem, child, createState (+7 more)
...
Cohesion: 0.08
Nodes (26): ../../attendance/data/attendance_model.dart, ../../../core/config/app_config.dart, ../../../core/network/api_client.dart, kpi_model.dart, ApiClient, _client, getMyKpi, _instance (+18 more)
...
Cohesion: 0.29
Nodes (11): AdminProfilePage, _handleLogout, _ChangePasswordPageState, _submit, _handleLogin, authRepositoryProvider, authStateProvider, _handleLogout (+3 more)
...
Cohesion: 0.12
Nodes (16): adminAuthDio, authDio, _isAuthenticationBootstrapEndpoint, onError, onRequest, _performRefresh, _refreshBeforeExpiry, refreshCoordinator (+8 more)

### Community 54 - "../../core/constants/app_colors.dart"
Cohesion: 0.13
Nodes (14): AttendanceRecord, AttendanceSummaryCard, build, _buildTimeRow, record, build, _buildPlaceholder, _buildSelfieThumbnail (+6 more)
...
Cohesion: 0.11
Nodes (12): package:flutter_test/flutter_test.dart, package:iderkopi_absensi/core/utils/location_utils.dart, package:iderkopi_absensi/features/attendance/data/attendance_model.dart, package:iderkopi_absensi/features/auth/data/auth_model.dart, package:iderkopi_absensi/features/holiday/data/holiday_model.dart, package:iderkopi_absensi/features/kpi/data/kpi_model.dart, main, main (+4 more)

### Community 67 - "shift_model.dart"
Cohesion: 0.06
Nodes (31): class, copyWith, date, endTime, _formatTime, fromJson, id, isActive (+23 more)
...
Cohesion: 0.12
Nodes (16): _buildCalendar, _buildLegend, _buildMonthPicker, _buildUpcomingShifts, color, createState, day, _firstWeekdayOffset (+8 more)

### Community 70 - "settings_providers.dart"
Cohesion: 0.07
Nodes (29): ../../../core/notifications/notification_providers.dart, ../../holiday/data/holiday_repository.dart, _applySchedule, checkInReminderEnabled, checkInReminderHour, checkInReminderMinute, checkOutReminderEnabled, checkOutReminderHour (+21 more)
...
Cohesion: 0.05
Nodes (43): core/router/app_router.dart, dart:async, features/sync/providers/sync_providers.dart, FlutterLocalNotificationsPlugin, build, _connectivitySub, createState, dispose (+35 more)
...
Cohesion: 0.12
Nodes (16): Animation, AnimationController, build, _controller, createState, dispose, _fadeAnimation, _logoController (+8 more)
...
Cohesion: 0.22
Nodes (9): ../data/leave_model.dart, leave_form_page.dart, build, _buildEmptyState, _formatDate, leave, _LeaveCard, LeaveListPage (+1 more)
...
Cohesion: 0.11
Nodes (19): RecapDay, build, _buildDetailTable, _buildMonthPicker, _buildSummaryRow, color, createState, day (+11 more)

### Community 86 - "outlet_picker_sheet.dart"
Cohesion: 0.11
Nodes (19): _getCurrentLocation, _getCurrentLocation, OutletDistance, build, createState, distance, _EmptyOutletState, isSelected (+11 more)
...
Cohesion: 0.07
Nodes (36): admin_user_form_page.dart, ../data/admin_user_model.dart, AdminUser, build, AdminUserDetailPage, _AdminUserDetailPageState, build, _buildDetailTile (+28 more)
...
Cohesion: 0.40
Nodes (4): app.dart, core/background/sync_worker.dart, main, package:flutter/foundation.dart
...
Cohesion: 0.12
Nodes (15): ../../../core/utils/location_utils.dart, ../data/outlet_model.dart, ../data/outlet_repository.dart, OutletRepository, any, distances, getOutlets, hasOutletInRadiusProvider (+7 more)
...
Cohesion: 0.13
Nodes (14): enabled, hour, icon, iconColor, minute, onTimeChanged, onToggle, _SectionHeader (+6 more)

### Community 100 - "settings_page_test.dart"
Cohesion: 0.22
Nodes (8): package:iderkopi_absensi/core/notifications/notification_providers.dart, package:iderkopi_absensi/features/settings/presentation/settings_page.dart, package:iderkopi_absensi/features/settings/providers/settings_providers.dart, package:shared_preferences/shared_preferences.dart, main, notificationService, prefs, main
...
Cohesion: 0.10
Nodes (23): ConsumerStatefulWidget, AdminAttendancePage, _AdminAttendancePageState, build, createState, _selectedFilterIndex, AdminUsersPage, adminAttendanceProvider (+15 more)

### Community 106 - "../../auth/providers/auth_providers.dart"
Cohesion: 0.40
Nodes (5): build, SettingsPage, notificationSettingsProvider, Route /profile, main
...
Cohesion: 0.50
Nodes (3): core/notifications/notification_service.dart, notificationServiceProvider, NotificationService
...
Cohesion: 0.18
Nodes (14): currentUserProvider, LeaveRequest, build, _buildEmptyState, _formatDate, _handleApprove, _handleReject, leave (+6 more)
...
Cohesion: 0.18
Nodes (11): AsyncListWidget, AsyncValueWidget, CachedImage, _PasswordField, _DateField, _DetailRow, _ReminderCard, _CalendarCell (+3 more)

### Community 121 - "attendance_bar_chart.dart"
Cohesion: 0.50
Nodes (4): build, ShiftSchedulePage, _ShiftSchedulePageState, myShiftsProvider
...
Cohesion: 0.12
Nodes (16): Dio, Dio get, _addDebugLogging, AuthApiClient, _create, _dio, forTesting, _instance (+8 more)
...
Cohesion: 0.20
Nodes (8): dart:io, compressImage, ImageUtils, package:camera/camera.dart, package:iderkopi_absensi/features/attendance/presentation/widgets/attendance_camera_status.dart, package:image/image.dart, package:path_provider/path_provider.dart, main
...
## Knowledge Gaps
- **1338 isolated node(s):** `iderkopi/auth-backend`, `updateAdminAccountStatusRequest`, `resetAdminAccountPasswordRequest`, `loginRequest`, `refreshRequest` (+1333 more)
...
- **Why does `Outlet` connect `outlet_model.dart` to `outlet_map_widget.dart`, `check_in_page.dart`, `admin_outlet_edit_page.dart`, `check_out_page.dart`, `outlet_picker_sheet.dart`?**
