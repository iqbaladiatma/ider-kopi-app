...
class _BottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      _NavItem(icon: Icons.camera_alt_outlined, activeIcon: Icons.camera_alt, label: 'Absen', path: '/check-in'),
      _NavItem(icon: Icons.receipt_long_outlined, activeIcon: Icons.receipt_long, label: 'Riwayat', path: '/history'),
          ...
          child: Row(
            ...
            children: items.map((item) {
              final isActive = currentPath == item.path ||
                  (item.path == '/check-in' && currentPath == '/check-out');
